namespace TablerForNet.Components
{
    public class TableGridDataFactory<Item> : ITableDataProvider<Item>
    {
        ...
        private IQueryable<Item> AddSorting(List<ITableColumn<Item>> columns, ITableState<Item> state,IQueryable<Item> query)
        {
        ...
        private IQueryable<Item> AddSearch(List<ITableColumn<Item>> columns, ITableState<Item> state,IQueryable<Item> query)
        {
