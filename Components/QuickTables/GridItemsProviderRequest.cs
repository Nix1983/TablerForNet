namespace TablerForNet.Components.QuickTables
{
    public struct GridItemsProviderRequest<TGridItem>
    {
        ...
        public Columns.QuickTableColumn<TGridItem> SortByColumn { get; }
        public bool SortByAscending { get; }
        public CancellationToken CancellationToken { get; }

        internal GridItemsProviderRequest(
            int startIndex, int? count, Columns.QuickTableColumn<TGridItem> sortByColumn, bool sortByAscending,
        ...
        private static string ColumnNotSortableMessage<T>(Columns.QuickTableColumn<T> col)
        {
            return
